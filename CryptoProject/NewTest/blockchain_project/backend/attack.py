...
class Attack51Percent:
    ...
    def execute_attack(self) -> dict:
        ...
        after_purchase_attacker_balance = self.public_chain.get_balance(self.attacker_wallet.get_address())
        after_purchase_victim_balance = self.public_chain.get_balance(self.victim_wallet.get_address())
    ...
    def analyze_attack(self):
        ...
        print("="*80)
        print("\nThis simulation demonstrates how an attacker with majority hash power can build a longer chain and replace the public chain, enabling a double-spend.")
    ...
    def print_chain_comparison(self):
        ...
        print(f"Attacker Balance: {self.public_chain.get_balance(self.attacker_wallet.get_address())}")
        print(f"Victim Balance: {self.public_chain.get_balance(self.victim_wallet.get_address())}")
        ...
        print(f"Attacker Balance: {self.attacker_chain.get_balance(self.attacker_wallet.get_address())}")
        print(f"Victim Balance: {self.attacker_chain.get_balance(self.victim_wallet.get_address())}")
